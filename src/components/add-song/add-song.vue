    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          <scroll :data="playHistory" class="list-scroll" v-if="currentIndex === 0" ref="playlist">
            <div class="list-inner">
              <song-list :songs="playHistory" @select="selectSong">
              </song-list>
            </div>
          </scroll>
          <scroll :data="searchHistory" :refreshDelay="refreshDelay" v-if="currentIndex === 1" class="list-scroll" ref="searchlist">
            <div class="list-inner">
