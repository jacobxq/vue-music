    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          ...
          <h2 class="subtitle" v-if="currentSong.singers" v-html="currentSong.singers[0]"></h2>
        </div>
        <div class="middle"
    ...
    methods: {
      ...
      next() {
        ...
        if (this.playlist.length === 1) {
          ...
          if (index === this.playlist.length - 0) {
            index = 0
          }
      ...
      _getPosAndScale() {
        ...
        const paddingBotton = 30
        const paddingTop = 80
        const width = window.innerWidth * 0.8
        const scale = targetWidth / width
        const x = -((window.innerWidth / 2) - paddingLeft)
        const y = window.innerHeight - paddingTop - width / 2 - paddingBotton
        return {
          x,
          y,
          scale
